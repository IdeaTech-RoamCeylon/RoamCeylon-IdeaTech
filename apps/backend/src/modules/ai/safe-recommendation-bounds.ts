...
export const SAFE_BOUNDS = Object.freeze({
  ...
  FEEDBACK: {
    ...
    TRUST_MULTIPLIER_MIN: 0.70,
    TRUST_MULTIPLIER_MAX: 1.50,
  ...
  RELEVANCE: {
    ...
    MIN_HIGH_CONFIDENCE_SCORE: 0.80,
    ...
    MIN_QUALITY_ACTIVITY_FRACTION: 0.40,
  } as const,
  ...
  INCREMENTAL: {
    ...
    MAX_SESSION_DELTA_PER_DIMENSION: 0.50,
...
export function describeBounds(): Record<string, unknown> {
  return {
    ...
    relevance: {
      ...
      avgScoreLowQualityAt:       SAFE_BOUNDS.RELEVANCE.AVG_SCORE_LOW_QUALITY_THRESHOLD,
    ...
    incremental: {
      maxSessionDeltaPerDimension: SAFE_BOUNDS.INCREMENTAL.MAX_SESSION_DELTA_PER_DIMENSION,
