...
describe('PlannerService - Feedback', () => {
    ...
    describe('submitFeedback', () => {
        ...
        it('should successfully submit feedback for own trip', async () => {
            ...
            mockPrismaService.tripFeedback.upsert.mockResolvedValue(mockFeedback);
            ...
            expect(mockPrismaService.tripFeedback.upsert).toHaveBeenCalledWith({
                where: {
        ...
        it('should throw BadRequestException if trip not found', async () => {
            ...
            expect(mockPrismaService.tripFeedback.upsert).not.toHaveBeenCalled();
        });
        ...
        it('should accept feedback with only rating', async () => {
            ...
            mockPrismaService.savedTrip.findUnique.mockResolvedValue(mockTrip);
            mockPrismaService.tripFeedback.upsert.mockResolvedValue({
                ...mockFeedback,
        ...
        it('should update existing feedback instead of creating duplicate', async () => {
            ...
            expect(mockPrismaService.tripFeedback.upsert).toHaveBeenCalledTimes(2);
        });
    });
});
