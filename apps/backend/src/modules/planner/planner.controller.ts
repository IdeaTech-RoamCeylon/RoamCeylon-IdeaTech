...
export class PlannerController {
    ...
    @Post('save')
    async saveTrip(@Req() req: RequestWithUser, @Body() body: TripData): Promise<SavedTrip> {
    ...
    @Delete(':id')
    async deleteTrip(@Req() req: RequestWithUser, @Param('id') id: string): Promise<SavedTrip> {
